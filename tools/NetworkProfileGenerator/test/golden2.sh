...
# Rule - BW + Loss
sudo tc class add dev gre1 parent 1a1a: classid 1a1a:20 htb rate 50Mbit
...
# Rule - BW + Delay + Loss
sudo tc class add dev gre1 parent 1a1a: classid 1a1a:30 htb rate 20Mbit
...
# Rule - BW + Loss
sudo tc class add dev gre2 parent 1a1a: classid 1a1a:20 htb rate 50Mbit
...
# Rule - BW + Delay + Loss
sudo tc class add dev gre2 parent 1a1a: classid 1a1a:30 htb rate 20Mbit
