...
# Config Interface
sudo ifconfig ens3 100.73.8.11 netmask 255.255.255.0

# Config Default Route
sudo ip route add 0.0.0.0/0 via 100.73.8.1 dev ens3
# sudo ip route del 0.0.0.0/0 via 100.73.8.1 dev ens3
# sudo ip route add 100.73.8.0/25 via 20.0.0.0
